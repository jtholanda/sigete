...
<title>${empresa} | Ranking de ${esportista}s por nível técnico</title>
  ...
  <div class="center">
    ...
    <div class="content_area">
        ...
        <div class="single_left_coloum_wrapper">
            <h2 class="title">Ranking Masculino Por Nível Técnico</h2>
        </div>

	<div class = "row">
		<form action="${linkTo[RankingController].pesquisaRankingMasculinoPorNivelTecnico}" method="POST">
			<div class="form-group col-sm-5">
					<label for="nivel">Escolha um nível técnico</label>
					<select name="idNivel" id="nivel" class="form-control">
					  <c:forEach items="${niveisTecnicosMasculino}" var="nivelTecnico">								
