    ...
    <br/>
      <div class="main_content floatleft">
        <div class="left_coloum floatleft">
          ...
          <div class="single_left_coloum_wrapper">
            ...
            <div class="single_left_coloum floatleft"><a href="/${contexto}/torneio/detalhes-do-torneio/${midiaUm.torneio.id}">
            <img src="${midiaUm.url}" alt="${midiaUm.titulo}"></a>
              <h3>${torneioUm.nome}</h3>
              <p>O torneio será realizado no(a) ${torneioUm.local.nome}. ${torneioUm.observacoesAdicionais}</p>
              <a class="readmore" href="${linkTo[TorneioController].detalhaTorneio(torneioUm.id)}">mais informações</a> </div>
            <div class="single_left_coloum floatleft"><a href="/${contexto}/torneio/detalhes-do-torneio/${midiaDois.torneio.id}">
		      <img src="${midiaDois.url}" alt="${midiaDois.titulo}"></a>
              <h3>${torneioDois.nome}</h3>
              <p>O torneio será realizado no(a) ${torneioDois.local.nome}. ${torneioDois.observacoesAdicionais}</p>
              <a class="readmore" href="${linkTo[TorneioController].detalhaTorneio(torneioDois.id)}">mais informações</a> </div>
            <div class="single_left_coloum floatleft"><a href="/${contexto}/torneio/detalhes-do-torneio/${midiaTres.torneio.id}">
		      <img src="${midiaTres.url}" alt="${midiaTres.titulo}"></a>
              <h3>${torneioTres.nome}</h3>
              <p>O torneio será realizado no(a) ${torneioTres.local.nome}. ${torneioTres.observacoesAdicionais}</p>
          ...
          <div class="single_left_coloum_wrapper">
            ...
            <c:forEach items="${noticiasLocais1}" var="noticiaLocal">
	            ...
	            <a href="${linkTo[InformativoController].detalhaInformativo(noticiaLocal.id)}">
				    ...
				    <c:if test="${noticiaLocal.imagemPrincipal==null}">
				      <img class="media-object" src="/${contexto}/imagens/logomarca.png" alt="...">
				    </c:if>
			    </a>
			    <a href="${linkTo[InformativoController].detalhaInformativo(noticiaLocal.id)}">
      ...
      <div class="sidebar floatright">
        ...
        <div class="single_sidebar">
          ...
          <div class="news-letter">
            ...
            <c:if test="${tenistaLogado == null }">
	            ...
	            <p>Sistema de Gestão de Competições de Tênis e Beach Tennis 3.0</p>
    		...
    		<div class="panel-heading">Painel do usuário<br/><br/><br/>                  
            Olá ${tenistaLogado.nome }!<br/><br/>
           ...
           <br/>
        <div class="panel panel-default">
    		<div class="panel-heading">Plus para Organizadores<br/><br/><br/>                  
           ...
           <br/>
        <div class="panel panel-default">
    		<div class="panel-heading">Plus para Administradores<br/><br/><br/>                 
				...
				<a href="${linkTo[AdminController].atribuiPontuacaoDeTenistasSemPontos}" ><small>Atribuir pontuação de ${contexto}s sem pontos</small></a><br/>
				<a href="${linkTo[AdminController].atribuiPontuacaoDeDuplasDosTenistas}" ><small>Atribuir pontuação de duplas dos ${contexto}s</small></a><br/>
        ...
        <div class="single_sidebar">
          ...
          <div class="single_sidebar"> <img src="imagens/clubes/logo_cb.jpg" alt="" /> </div>
