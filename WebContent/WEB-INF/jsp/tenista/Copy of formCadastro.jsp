...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
 <title>Portal do Tênis Paraibano | Cadastro de tenista</title>
  ...
  <div class="center">
    ...
    <div class="content_area">
        ...
        <div class="single_left_coloum_wrapper">
            <h2 class="title">Cadastro de tenistas</h2> 
            <div align="center"><small> Se você já for cadastrado não realize um novo cadastro, pois você poderá receber punições. </small></div>
        </div>
			...
			<form action="${linkTo[TenistaController].solicitaCadastroTenista}" method="POST" name = "solicitaCadastroTenista">
				...
				<div class="btn-toolbar" align="center">
					<button type="submit" class="form-group col-sm-12 btn btn-success pull-center">Solicitar cadastro de tenista</button>
				</div>
			</form>
		</div>
