...
<c:import url="../menu/googleAnalitics.jsp"></c:import>
   ...
   <!-- cabeçalho -->
    <div class="header_area">
      <div class="logo floatleft"><a href="${linkTo[IndexController].index}"><img src="/${contexto}/imagens/logomarca_menor.png" alt="" height="200" width="200"/></a></div>
		...
		<div class="social">
          ...
          <ul>
            ...
            <a href="https://www.instagram.com/portaldotenispb/">			
            	<img src="/${contexto}/imagens/instagram.png" alt="" height="25" width="25"/>
            </a>
          </ul>
    ...
    <div class="main_menu_area">
      <ul id="nav">
        ...
        <li><a href="#">Tenista</a>
          <ul>
            <li><a href="${linkTo[TenistaController].formCadastro}">Cadastro</a></li>
            <li><a href="${linkTo[TenistaController].formProcuraTenistas}">Procurar ${esportista}s</a></li>
            <li><a href="${linkTo[TenistaController].visualizaFiliados}">Filiado</a></li>
          </ul>
        </li>
        <li><a href="#">Torneios</a>
          <ul>
            <li><a href="${linkTo[TorneioController].visualizaTorneios(0,0)}">Torneios do ranking</a></li>
        ...
        <li><a href="#">Ranking</a>
          <ul>
            <li><a href="${linkTo[RankingController].visualizaRankingPorNivelTecnico}">Ranking por categorias</a></li>
            <li><a href="${linkTo[RankingController].visualizaRankingMasculinoPorNivelTecnico}">Ranking masculino</a></li>
        ...
        <li><a href="#">Parceiros</a>
          <ul>
            <li><a href="${linkTo[MaisController].filiacao}">Filiação</a></li>
