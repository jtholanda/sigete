  ...
  <div class="center">
    ...
    <div class="content_area">
        ...
        <div class="single_left_coloum_wrapper">
   		...
   		<form action="${linkTo[JogoDeTorneioController].confirmaJogoDeTorneioComHorarioEspecial}" method="POST">
				...
				<div class="row">
					...
					<label>${jogo.tenistaUm.nome}</label>
				...
				<div class="row">
					<div class="checkbox col-sm-12">
					<label>${jogo.tenistaDois.nome}</label>
