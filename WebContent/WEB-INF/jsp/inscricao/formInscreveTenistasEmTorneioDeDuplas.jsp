...
<title>${empresa} | Inscrição de ${esportista}s em torneio de duplas</title>
  ...
  <div class="center">
    ...
    <div class="content_area">
        ...
        <div class="single_left_coloum_wrapper">
            <h2 class="title">Inscrever uma dupla</h2>
        </div>
    ...
    <hr>
			...
			<form action="${linkTo[InscricaoController].confirmaInscricaoDoTenistaNoTorneioDeDuplas}" method="POST" > 
			...
			<h4>Primeiro ${esportista}</h4><br/>
						...
						<select name="inscricao.tenista.id" id="tenistas" class="form-control">
			...
			<h4>Segundo ${esportista}</h4><br/>
						...
						<select name="inscricao.tenistaParceiro.id" id="tenistasParceiros" class="form-control">
						  <option value="0">Escolha um ${esportista} para parceiro na dupla</option>
			...
			<div class="row">
			<div class="form-group col-sm-12">
				<h4>Escolha o nível técnico que o ${esportista} deseja se inscrever</h4><br/>
							
							<select name="inscricao.nivel.id" id="niveis" class="form-control">
		...
		<div class="form-group col-sm-12">
			...
			<textarea class="form-control" name="inscricao.horarioEspecial"></textarea>
		</div>
		</div>

		<div class="row" align="center">
		<label class="checkbox col-sm-12">
		<input type="checkbox" id="inscricao.paga" name="inscricao.paga" />Marque se o pagamento foi efetuado.</label>
		</div>	
				
				<div class="btn-toolbar ">
				
					<button class="btn btn-success">Inscrever dupla</button>
