...
<title>${empresa} | Inscrição de ${esportista} em torneio</title>
  ...
  <div class="center">
    ...
    <div class="content_area">
        ...
        <div class="single_left_coloum_wrapper">
            <h2 class="title">Inscrever um ${esportista}</h2>
        </div>
    ...
    <hr>
			...
			<form action="${linkTo[InscricaoController].confirmaInscricaoDoTenistaNoTorneio}" method="POST" > 

			<input type="hidden" name="inscricao.torneio.id" value="${torneio.id}">
			<div class="row">
			<div class="form-group col-sm-12">
			<h4>Escolha o ${esportista}</h4><br/>
						
						<select name="inscricao.tenista.id" id="tenistas" class="form-control">
						  <option value="0">Escolha um tenista</option>
			...
			<div class="row">
			<div class="form-group col-sm-12">
				<h4>Escolha o nível técnico</h4><br/>
			...
			<div class="row">
				<div class="form-group col-sm-12">
				<h4>Horário especial de jogos (evite usar!)</h4>
		...
		<label class="checkbox col-sm-12">
			<input type="checkbox" id="inscricao.paga" name="inscricao.paga" />Marque se o pagamento foi efetuado.</label>
				...
				<div class="btn-toolbar ">
					...
					<button type="submit" class="btn btn-success" >Inscrever ${esportista}</button>
